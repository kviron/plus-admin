	...
	public function output() {
		...
		echo cssf_add_element( array(
			...
			'options'	=> [
				...
				esc_attr__('Material Design Easing Curves') => [
				...
				esc_attr__('Penner Equations (approximated)')	=> [
				...
				esc_attr__('Custom Easing')	=> [
					$customValue 	=> esc_attr__('Custom Easing')
				]
			],
		...
		echo cssf_add_element( array(
			...
			'value'		=> esc_attr__('Toggle Editor'),
		) );
