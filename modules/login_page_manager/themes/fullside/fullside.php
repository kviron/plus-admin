...
class Plus_admin_login_theme_Fullside extends Plus_admin_Login_Theme{
		...
		$settings 		= array(
			...
			'fields'		=> array(
				...
				array(
                    ...
                    'default'       => array(
						'external_image'	=> $theme_path . '/fullside-bg.jpg',
                        'repeat'     		=> 'no-repeat',
                        'position'   		=> 'center center',
						'attachment' 		=> 'fixed',
						'size'				=> 'cover',
				...
				array(
					...
					'type'      => 'wysiwyg',
					'title'     => __('Welcome Title Text','plus_admin'),
					'desc'      => __('Enter the text to use as a welcome title','plus_admin'),
					'default'	=> __('Welcome to <strong>PLUS</strong>','plus_admin'),
					'settings'  => array(
						'textarea_rows' => 5,
						'tinymce'       => true,
						'media_buttons' => false,
				...
				array(
					...
					'type'      => 'wysiwyg',
					'title'     => __('Welcome Message Text','plus_admin'),
					'desc'      => __('Enter the text to use as a welcome intro message','plus_admin'),
					'default'	=> __('Welcome back, Please Login to your account or Register','plus_admin'),
					'settings'  => array(
						'textarea_rows' => 5,
						'tinymce'       => true,
						'media_buttons' => false,
				...
				array(
					...
					'default'	=> __('By signing up you agree with our <a href="http://www.castorstudio.com" target="_blank">Terms and Conditions</a> & <a href="http://www.castorstudio.com" target="_blank">Privacy Policy</a>','plus_admin'),
					'settings'  => array(
						'textarea_rows' => 5,
						'tinymce'       => true,
						'media_buttons' => false,
	...
	function enqueue_scripts(){
		...
		wp_enqueue_style('cs-plus-admin-google-fonts','https://fonts.googleapis.com/css?family=Dosis:100,300,400,700', false ); 
	...
	function render_header_title_html($message){
		...
		if ($current_page == 'register'){
			...
			$output_message .= "
				<div class='cs-plus-admin-login-title'>
					<h2>{$welcome_title}</h2>
					<div class='cs-plus-admin-login-title-lead'>
						<p>{$welcome_msg}</p>
					</div>
				</div>
			";
