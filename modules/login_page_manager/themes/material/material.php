...
class Plus_admin_login_theme_Material extends Plus_admin_Login_Theme{

	public function __construct(){
		parent::__construct();

        $this->theme_name   = 'material';
	...
	public function get_settings(){
		...
		$settings 		= array(
			...
			'fields'		=> array(
                array(
					'type'			=> 'subheading',
					'content'		=> __('Material Theme Settings'),
				),
				array(
				...
				array(
                    ...
                    'default'       => array(
						'external_image'	=> $theme_path . '/material-bg.jpg',
                        'repeat'     		=> 'no-repeat',
                        'position'   		=> 'center center',
						'attachment' 		=> 'fixed',
						'size'				=> 'cover',
	...
	public function parse_settings($settings){
		...
		// ==========================================================================
		$output = "
		@import url(https://fonts.googleapis.com/css?family={$typography});
		:root{
